...
par <- list(
  dropout1 = c(0.3,0.4),
  neurons1 = c(128,250, 350, 450, 500, 550, 600),
  lr = c(0.0001,0.001),
...
# perform runs
runs2 <- tuning_run('./src/layer2_model.R', sample = 0.4, runs_dir = '_tuning2', flags = par)
...
# perform runs
runs3 <- tuning_run('./src/layer3_model.R', sample = 0.4, runs_dir = '_tuning3', flags = par)
...
# perform runs
runs4 <- tuning_run('./src/layer4_model.R', sample = 0.4, runs_dir = '_tuning4', flags = par)
...
# perform runs
runs5 <- tuning_run('./src/layer5_model.R', sample = 0.4, runs_dir = '_tuning5', flags = par)
