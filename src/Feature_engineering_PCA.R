...
##############################################################
##############################################################
# This is the version of the Feature engineering file with PCA
# Our final predictions are NOT based on this version of the gold data
# Final predictions are based on the feature engineering in "Feature_engineering"
#
...
##############################################################
##############################################################
# 5. Write data away to Gold layer
##############################################################
##############################################################
